...
from nemo.collections.tts.models import EasyMagpieTTSAcousticTransformerModel
...
def main(cfg):
    ...
    if mode == 'train':
        model = EasyMagpieTTSAcousticTransformerModel(cfg=cfg.model, trainer=trainer)
    elif mode == 'test':
        model = EasyMagpieTTSAcousticTransformerModel(cfg=cfg.model, trainer=trainer)
    else:
