...
class EasyMagpieTTSSemanticModel(EasyMagpieTTSInferenceModel):
    """
    ...
    def compute_loss(self, logits, audio_codes, audio_codes_lens):
        ...
        audio_codes_lens: (B,)
        """
        audio_codes = audio_codes[:, :self.num_audio_codebooks_train, :]
    ...
    def log_val_audio_example(
        ...
        pred_audio_codes = self.acoustic_model.infer(
            semantic_tokens=pred_audio_codes,
            semantic_lens=pred_audio_codes_lens,
        ...
        if batch_idx == 0 and self.global_rank == 0:
            ...
            wandb_log_dict.update(
                self.log_val_audio_example(
                    logits, audio_codes_target, audio_codes_lens_target, raw_texts, context_audio_codes, context_audio_codes_lens
                )
            )
